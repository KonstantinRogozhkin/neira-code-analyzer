...
from .analysis_action_executor import AnalysisActionExecutor, AnalysisExecutionSummary
...
class AnalysisAIResponse:
    ...
    next_focus: Optional[str] = None  # Следующий фокус анализа
...
"""
        ...
        if ai_response.suggested_actions:
            report += f"### 🛠️ Рекомендуемые действия:\n\n"
            for i, action in enumerate(ai_response.suggested_actions, 1):
